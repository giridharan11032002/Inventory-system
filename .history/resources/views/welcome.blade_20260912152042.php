...
<script>
    $(document).on('click', '.add-product', function () { let id = $(this).data('id'); let quantityInput = $('.product-quantity[data-id="' + id + '"]'); let quantity = parseInt(quantityInput.val()); let stock = parseInt(quantityInput.data('stock')); if (quantity < stock) { quantityInput.val(quantity + 1); } else { alert('Stock limit reached'); } }); $(document).on('click', '.remove-product', function () { let id = $(this).data('id'); let quantityInput = $('.product-quantity[data-id="' + id + '"]'); let quantity = parseInt(quantityInput.val()); if (quantity > 0) { quantityInput.val(quantity - 1); } });
</script>
