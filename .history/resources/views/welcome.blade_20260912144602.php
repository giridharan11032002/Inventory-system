    ...
    <div class="fluid p-2">
        ...
        <div class="card border-rounded mt-3">
            ...
            <div class="row">
                ...
                ">
                <div class="col-md-4">
                    <label for="customer_name" class="form-label require">Customer Name</label>
                    <input type="text" name="customer_name" class="form-control" id="customer_name">
                </div>
                <div class="col-md-4">
                    <label for="email" class="form-label require">Customer Name</label>
                    <input type="email" name="customer_name" class="form-control" id="customer_name">
                </div>
            </form>
            </div>
