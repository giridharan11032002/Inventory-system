                                        ...
                                        <div class="card h-100 shadow-sm">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" name="products[{{ $item->id }}][amount]"
                                                    ...
                                                    value="0">
                                                <input type="hidden" name="products[{{ $item->id }}][tax_percentage]"
                                                    class="product-tax" data-id="{{ $item->id }}"
                                                    value="0">
