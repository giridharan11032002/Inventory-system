    ...
    <div class="container-fluid p-2">
        ...
        <div class="card mt-3 rounded-3">
            ...
            <div class="card-body">
                ...
                <form id="customer" autocomplete="off" action="{{ admin_url('generate/bill') }}" method="POST">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        data-stock="{{ $item->stock }}" style="width: 60px;" readonly>
            ...
            $('#specific_location_add').validate({
                rules: {
                    ...
                    reg_no: {
                        ...
                        // pattern: /^[a-zA-Z0-9-\s]+$/,
                        // remote: {
                        //     url: '{{ admin_url('company/reg_unique') }}',
                        //     type: 'post',
                        //     data: {
                        //         reg_no: function() {
                        //             return $('#reg_no').val();
                ...
                messages: {
                    ...
                    company_name: {
                        ...
                        pattern: "{{ __('Only letters, numbers, and (-) are allowed.') }}"
                    ...
                    //     remote: "{{ __('Company Short Name should be unique') }}"
