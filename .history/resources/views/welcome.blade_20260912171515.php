                ...
                <form id="customer" autocomplete="off" action="{{ url('generate/bill') }}" method="POST">
                                        ...
                                        <div class="card h-100 shadow-sm">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-2 small text-muted">
                                                    Line Amount: ₹<span class="line-amount" data-id="{{ $item->id }}">0.00</span>
                                                    &nbsp;|&nbsp;
                                                    Line Tax: ₹<span class="line-tax" data-id="{{ $item->id }}">0.00</span>
                                                </div>
                                                ...
                                                <input type="hidden"
                                                    name="products[{{ $item->id }}][amount]"
                                                    class="product-amount" data-id="{{ $item->id }}" value="0">

                                                <input type="hidden"
                                                    name="products[{{ $item->id }}][tax_amount]"
                                                    class="product-tax-amount" data-id="{{ $item->id }}" value="0">

                                                <input type="hidden"
                                                    name="products[{{ $item->id }}][total_amount]"
                                                    class="product-total-amount" data-id="{{ $item->id }}" value="0">
                    ...
                    <div class="card mt-4 rounded-3">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="order_quantity_total" id="orderQuantityTotal" value="0">
